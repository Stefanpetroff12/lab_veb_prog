...
public class DataHolder {
    ...
    public void init(){
        ...
        songs = new ArrayList<>();
        songs.add(new Song("Tusa", "latin", 2019, albums.get(0)));
        songs.add(new Song("Posljedni ljet", "serbian", 2004, albums.get(0)));
        songs.add(new Song("Anaconda", "rap", 2018, albums.get(0)));
        songs.add(new Song("Telephone", "pop", 2010, albums.get(0)));
        songs.add(new Song("I'm legit", "rap", 2015, albums.get(0)));
